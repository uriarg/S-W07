...
estimation(optim=('MaxIter',1000),datafile=spaingooddata,mode_file=usmodel_shock_decomp_mode,mode_compute=1,first_obs=1, presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2, nodiagnostic, tex);
write_latex_prior_table;  

shock_decomposition y;
shock_decomposition c,pinf,lab,r;
stoch_simul(irf=20) y,c,pinf,lab,r,dy, pinfobs, robs ;
shock_decomposition dy;